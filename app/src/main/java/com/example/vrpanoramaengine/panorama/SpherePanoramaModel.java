...
public class SpherePanoramaModel extends Object3D {
    ...
    public SpherePanoramaModel(float radius, int segmentsW, int segmentsH) {
        this(radius, segmentsW, segmentsH, true, false, true);
    }

    public SpherePanoramaModel(float radius, int segmentsW, int segmentsH, boolean mirrorTextureCoords) {
        this(radius, segmentsW, segmentsH, true, false, true, mirrorTextureCoords);
    }

    public SpherePanoramaModel(float radius, int segmentsW, int segmentsH, boolean createTextureCoordinates,
