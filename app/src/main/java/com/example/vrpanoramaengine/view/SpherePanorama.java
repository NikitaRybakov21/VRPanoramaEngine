...
public class SpherePanorama extends Object3D {
    ...
    public SpherePanorama(float radius, int segmentsW, int segmentsH) {
        this(radius, segmentsW, segmentsH, true, false, true);
    }

    public SpherePanorama(float radius, int segmentsW, int segmentsH, boolean mirrorTextureCoords) {
        this(radius, segmentsW, segmentsH, true, false, true, mirrorTextureCoords);
    }

    public SpherePanorama(float radius, int segmentsW, int segmentsH, boolean createTextureCoordinates,
